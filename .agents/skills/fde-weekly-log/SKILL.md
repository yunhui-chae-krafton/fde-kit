---
name: fde-weekly-log
description: Space & Property FDE 주간 로그를 Confluence FDEWORK 페이지와 krafton-slack-mcp 증빙 기반으로 작성하거나 재작성한다. 특정 기간의 FDE weekly log, 산출물 중심 로그, Meetings/Project/Slack 근거 수집, 임팩트 과제와 규격 외 인입 요청 분리가 필요할 때 사용한다.
---
